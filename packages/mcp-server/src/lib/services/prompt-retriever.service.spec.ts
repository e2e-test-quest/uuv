                    ...
                    [
                        {
                            ...
                            path: ["promptName"],
                            message: "Invalid discriminator value. Expected 'genTestExpectTable' | 'genNominalTestCase' | 'genTestExpectRoleAndName' | 'genTestClickRoleAndName' | 'genTestWithinRoleAndName' | 'genTestTypeRoleAndName' | 'genTestExpectDomSelector' | 'genTestClickDomSelector' | 'genTestWithinDomSelector' | 'installUuvDependency' | 'checkUuvDependency' | 'getUuvVersion'",
                        },
                    ],
                    null,
                    2
