...
class BoolWithConfidence(BaseModel):
    value: bool = Field(
        description="Boolean answer based strictly on the analysis of the image and its context in html_page" # noqa E501.
    )
    confidence: float = Field(
        description="Confidence score between 0 (very uncertain) and 1 (absolutely certain)" # noqa E501.
    )
...
class UUVImageClassifierAgent(dspy.Module):
    ...
    @staticmethod
    def extract_nearest_words_around_image(html_content: str, css_selector: str, word_limit: int = 100): # noqa E501.
    ...
    def forward(self, image_description: str, html_content: str, css_selector: str) -> ImageClassifierResult: # noqa E501.
