    ...
    Usecase.init(
        {
            ...
            location: {
                ...
                set(value: { file: string, line: string, column: string }) {
        ...
        },
        {
            ...
            defaultScope: {
                attributes: {
                    exclude: ["locationFile", "locationLine", "locationColumn"],
                },
            },
        }
    );
    ...
    AccessibilityIssue.init(
        {
            ...
            runnerExtras: {
                ...
                set(value: { description: string; impact: string; help: string; helpUrl: string }) {
        ...
        },
        {
            ...
            timestamps: false,
            getterMethods: {
                runnerExtrasDescription: function () {
                    return undefined;
                },
                runnerExtrasImpact: function () {
                    return undefined;
                },
                runnerExtrasHelp: function () {
                    return undefined;
                },
                runnerExtrasHelpUrl: function () {
                    return undefined;
                },
            },
        }
